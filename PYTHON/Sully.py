...
if __name__ == "__main__":
    ...
    code = "import os%c%cif __name__ == %c__main__%c:%c%c    i = %d%c    i -= 1%c%c    if (i <= 0):%c        exit(0)%c%c    filename = %cSully_%c + str(i) + %c.py%c%c    execution = %cpython3 Sully_%c + str(i) + %c.py%c%c%c    code = %c%s%c%c%c    file = open(filename, %cw%c)%c    file.write(code%%(10, 10, 34, 34, 10, 10, i, 10, 10, 10, 10, 10, 10, 34, 34, 34, 34, 10, 34, 34, 34, 34, 10, 10, 34, code, 34, 10, 10, 34, 34, 10, 10, 10, 10, 10, 34, 34))%c%c    file.close()%c%c    os.system(%cpython3 %c + filename)"

    file = open(filename, "w")
    file.write(code%(10, 10, 34, 34, 10, 10, i, 10, 10, 10, 10, 10, 10, 34, 34, 34, 34, 10, 34, 34, 34, 34, 10, 10, 34, code, 34, 10, 10, 34, 34, 10, 10, 10, 10, 10, 34, 34))
